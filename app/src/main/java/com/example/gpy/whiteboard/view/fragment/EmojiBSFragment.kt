package com.example.gpy.whiteboard.view.fragment
...
class EmojiBSFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        // Initialize this lazily or in a way that respects context access if needed, 
        // but since we need context to get the string array, we might handle it differently.
        // For now, let's keep it static but initialize it once somehow, or just load it every time?
        // Better: Load it lazily.
